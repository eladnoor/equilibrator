...
we find that Δ\ :sub:`r`\ G'\ :sup:`m` ≈ -2910 kJ / mol. According to our calculation from above, that's enough energy to make ~65 ATP (in theory). But most organisms generate 30 ATP or less through the oxidization of glucose (`Nelson et al., 2008; Flamholz et al., 2014 <refs.html>`_). [#gox1]_
...
giving a Δ\ :sub:`r`\ G'\ :sup:`m` of around -1350 kJ / mol. [#gox2]_ In other words, there's more free energy! Cells could, in principle, make a lot more ATP than they do in practice. Which begs the question: why not make more ATP? If you're interested in learning more, consider looking up "chemical motive force" for reversible reactions.

.. [#gox1] See `BioNumbers ID 111475 <http://bionumbers.hms.harvard.edu/bionumber.aspx?&id=111475&ver=3&trm=atp%20yield%20flamholz>`__, which discusses ATP yield from glucose in yeast, for example.
.. [#gox2] Remember Δ\ :sub:`r`\ G'\ :sup:`m` assumes all concentrations are 1 mM.
